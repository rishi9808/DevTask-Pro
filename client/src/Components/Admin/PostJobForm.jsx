    ...
    <div class="card" style={{ "borderRadius": "15px", 'border': 'none' }}>
      <div class="card-body p-5" style={{display:"flex",justifyContent:"center",flexDirection:"column",margin:'0px',alignItems:"center"}}>
        ...
        <form onSubmit={handleSubmit} style={{display:"flex",justifyContent:"center",flexDirection:"column",margin:'0px'}}>
          ...
          <div class="form-outline mb-4">
            <label class="form-label" for="form3Example5cg">Expected Time to do task</label>
            <input type="number" id="form3Example5cg" class="form-control form-control-lg" name="timeReq" value={Data.timeReq} onChange={handleChange} required/>
          </div>

          <div class="form-outline mb-4">
            <label class="form-label" for="form3Example6cg">Skill</label>
