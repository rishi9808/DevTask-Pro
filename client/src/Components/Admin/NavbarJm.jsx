    ...
    >
      ...
      <div className="collapse navbar-collapse" id="navbarCollapse">
        <div className="navbar-nav ms-auto p-4 p-lg-0">
          <Link to="/jmhome" className="nav-item nav-link">
            Home
          </Link>
          <Link to="/adfinished" className="nav-item nav-link ">
            Finished Tasks
          </Link>
          <Link to="/adworking" className="nav-item nav-link">
            Working Tasks
          </Link>
          <Link to="/adpending" className="nav-item nav-link">
            Pending Tasks
          </Link>
        </div>
      </div>
